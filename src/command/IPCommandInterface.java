...
/**
 * Command Design Pattern Interface: This represents a command or operation that
 * can be performed
 * on an image. Responsible for delegating the command calls to their respective
 * IPModel methods.
 */
