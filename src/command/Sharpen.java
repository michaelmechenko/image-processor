...
/**
 * sharpen command: this calls the method that sharpens the image in the format that is compatible
 * with the command design pattern.
 */
public class Sharpen implements IPCommandInterface {

  /**
   * sharpens an image (increases contrast) by calling the method on the model that is given.
